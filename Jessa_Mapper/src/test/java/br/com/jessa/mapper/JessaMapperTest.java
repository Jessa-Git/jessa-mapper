...
public class JessaMapperTest {
	...
	public void testMapperNullObject() {
		JessaMapper.implement(MapperTestInterface.class).toTestStringSourceMapToDestiny(null);
	}
	...
	public void testMapperObjectNoAnnotation() {
		...
		MapperObjectTestDestiny destinyTest;
		destinyTest = JessaMapper.implement(MapperTestInterface.class)
				.toTestSourceMapToDestinyNoAnnotations(sourceTest);
		assertNotNull(destinyTest);
